...
public class MemberServiceImpl implements MemberService, UserDetailsService {
    ...
    // // 중복 이메일 검사
    // public void validateDuplicateEmail(String memberEmail) throws
    ...
    // // 비밀번호 수정
    // @Override
    // public void passwordUpdate(UpdatedPasswordDto pDto) throws
    // IllegalStateException {

    // Member member =
    // memberRepository.findByMemberEmail(pDto.getMemberEmail()).get();
    ...
    // @Override
    // @Transactional
    // public void memberWithdrawal(MemberDto memberDto) throws
    // IllegalStateException {

    // Member member =
    // memberRepository.findByMemberEmail(memberDto.getMemberEmail()).get();
