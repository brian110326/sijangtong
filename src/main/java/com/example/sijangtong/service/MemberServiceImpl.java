...
public class MemberServiceImpl implements MemberService, UserDetailsService {
    ...
    public void nickNameUpdate(MemberDto updateMemberDto) {
        ...
        memberRepository.updateNickname(updateMemberDto.getMemberNickname(), updateMemberDto.getMemberEmail());
    }
    ...
    public void addressUpdate(MemberDto updateMemberDto) {
        ...
        memberRepository.updateAddress(updateMemberDto.getMemberAddress(), updateMemberDto.getMemberEmail());
    }
