...
public class OrderServiceImpl implements OrderService {
    ...
    public PageResultDto<OrderDto, Object[]> getOrderList(PageRequestDto pageRequestDto, Long storeId) {
        ...
        Function<Object[], OrderDto> fn = (en -> entityToDto((Order) en[0],
                (List<OrderItem>) Arrays.asList((OrderItem) en[1]), (Rider) en[2], (Member) en[3],
    ...
    public Long updateOrder(OrderDto orderDto) {
        ...
        orderRepository.updatePayment(orderDto.getOrderPayment(),
                orderDto.getOrderId());
    ...
    public void updateOrderAmount(OrderItemDto orderItemDto) {
        orderItemRepository.updateAmount(orderItemDto.getOrderAmount(), orderItemDto.getId());
    }
